            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            SERVICIOS
                            <small>En este modulo se puede verificar los nuevos servicios </small>
                        </h2>
                    </div>
                    <div class="body">                          
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="basic-table">
                         ...
                         <?php foreach($date as $item) {
                                        echo "<tr>";
                                        echo "<td>". $item['Id_Regis_Ser']. "</td>";
                                        echo "<td>". $item['Nombre_Servicio']. "</td>";
                                        echo "<td>". $item['Valor_Servicio']. "</td>";
                                        echo "<td>". $item['Codigo_Servicio']. "</td>";
                                        echo "<td>". $item['A_quien_va_dirigido']. "</td>";
                                        echo "<td>". $item['Fecha_Crea']. "</td>";
                                        echo "<td>". $item['Hora']. "</td>";
                                        echo "<td>". $item['Id_citas']. "</td>";
