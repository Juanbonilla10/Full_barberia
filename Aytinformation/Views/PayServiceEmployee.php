...
<head>
    ...
    <!-- noUISlider Css -->
    <link href="../plugins/nouislider/nouislider.min.css" rel="stylesheet" <!-- Animation Css -->
            ...
            <div class="demo-settings">
                ...
                <ul class="setting-list">
                    <li>
                        ...
                        <div class="switch">
                         iuytrewpy                              <label><input type="checkbox" checked><span class="lever"></span></label>
                     </div>
                 </li>
                 <li>
...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>Registro De Pagos Barber Shop AYT</h2>
        </div>
    </div>
    <!-- Masked Input -->
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <h2>
                        Registra aquí los servicios que los barberos realizan para así saber cual es su saldo total.
                        <small><a href="https://github.com/RobinHerbots/jquery.inputmask"target="_blank"></a></small>
                    </h2>
                </div>
                <form action="" method="post">
                <div class="body">                          
                    <div class="row clearfix js-sweetalert">
                        <button type="button" class="btn bg-red waves-effect mover" onclick="Imprimir();">Imprimir</button>
                        <button type="submit" class="btn bg-red waves-effect mover" onclick="ventana();">Guardar</button>
                    </div>
                </div>
                <div class="body">
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" name="codigo_pago" class="form-control datetime" placeholder="Ex: C0000">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <b>Codigo del cliente</b>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="material-icons">nfc</i>
                            </span>
                            <div class="form-line">
                                <input type="text" name="codigo_cliente" class="form-control datetime" placeholder="Ex: C0000">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <b>Nombre del Barbero</b>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="material-icons">font_download</i>
                            </span>
                            <div class="form-line">
                                <input type="text" name="nombre_barbero" class="form-control time24" placeholder="text">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <b>Fecha en que atiende el servicio</b>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="material-icons">date_range</i>
                            </span>
                            <div class="form-line">
                                <input type="date" name="fecha_servicio" class="form-control date" placeholder="Ex: 30/07/2016">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="time" name="hora_servicio" class="form-control time24" placeholder="Ex: 23:59">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="number" name="valor_servicio" class="form-control money-dollar"
                    ...
                    <div class="col-md-3">
                        <b>Fecha de pago al Barbero</b>
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="material-icons">date_range</i>
                            </span>
                            <div class="form-line">
                                <input type="date" name="fecha_pago_barbero" class="form-control date" placeholder="Ex: 30/07/2016">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" name="saldo_total" class="form-control money-dollar"
                                placeholder="Ex: $ 9.999 ">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" name="abono" class="form-control money-dollar"
                                placeholder="Ex: $ 9.999 ">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="number" name="saldo_pendiente" class="form-control money-dollar"
                                placeholder="Ex: $ 9.999 ">
                            </div>
                        </div>
                    </div>
