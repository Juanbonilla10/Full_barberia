                ...
                <div class="card">
                 <div class="body">
                   ...
                   foreach($datas as $items){
                        echo "<tr>";
                        echo "<td>". $items['Nit']. "</td>";
                        echo "<td>". $items['Nombre_Proveedor']. "</td>";
                        echo "<td>". $items['Razon_social']. "</td>";
                        echo "<td>". $items['fecha']. "</td>";
                        echo "<td>". $items['Num_celular']. "</td>";
                        echo "<td>". $items['Numero_telefono']. "</td>";
                        echo "<td>". $items['Dias_pago_Credito']. "</td>";
                        echo "<td>". $items['Ciudad']. "</td>";
