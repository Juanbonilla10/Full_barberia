                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Ventas / Insumos</th>
                                        <!--<th>Opción</th>!-->
                                    </tr>
                                </thead>
                               <?php foreach($dates as $item) {
                                        echo "<tr>";
                                        echo "<td>". $item['Referencia_Producto']. "</td>";
                                        echo "<td>". $item['Codigo_De_barras']. "</td>";
                                        echo "<td>". $item['Descripcion']. "</td>";
                                        echo "<td>". $item['Proveedor']. "</td>";
                                        echo "<td>". $item['Fecha']. "</td>";
                                        echo "<td>". $item['Precio_proveedor']. "</td>";
                                        echo "<td>". $item['Precio_publico']. "</td>";
                                     echo "<td>". $item['Ventas_insumos']. "</td>";
                                    echo "</tr>";
                                    }
                                ?>
...
<script src="../js/pages/ui/modal_cita.j</script>
