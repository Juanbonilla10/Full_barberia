                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>En este modulo se puede registrar los nuevos trabajadores de la empresa </small>
                            </h2>
                        </div>
                        <div class="body">                          
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="text" name="" class="form-control date" placeholder="User name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="text" name="nombres" class="form-control date" placeholder="User name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="number" name="identificacion" class="form-control document" placeholder="Numero de identificacion">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="tel" name="telefono"class="form-control mobile-phone-number" placeholder="Ex: +57 (317) 289-07-63">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="date" name="fechana" class="form-control date" placeholder="Ex: 30/07/2016">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="tel" name="correo" class="form-control mobile-phone-number" placeholder="juan@gmail.com">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="text" name="genero" class="form-control" placeholder="Feminio/Masculino">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="password" name="passwo" class="form-control date" placeholder="contraseña">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
