            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            INVENTARIOS
                            <small>En este modulo se puede verificar las existencias de los productos </small>
                        </h2>
                    </div>
                    <div class="body">                          
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="defaultModalLabel">Modificar inventario</h4>
                                    </div>
                                     ...
                                     <div class="demo-masked-input">
                                        <div class="row clearfix unicos">
                                            ...
                                            <div class="col-md-6 bloqueo t">
                                                <b>Motivo ingreso o salida</b>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="material-icons">person</i>
                                                    </span>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control date" placeholder="Descripcion" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="number" class="form-control document" placeholder="- +" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="tel" class="form-control mobile-phone-number" placeholder="1007400892" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                <b>Precio de ingreso / salida</b>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="material-icons">attach_money</i>
                                                    </span>
                                                    <div class="form-line">
                                                        <input type="number" class="form-control money" placeholder="$ 20000" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="basic-table">
                         ...
                         <?php foreach($data as $item) {
                                        echo "<tr>";
                                        echo "<td>". $item['Codigo_del_pago']. "</td>";
                                        echo "<td>". $item['Codigo_Cliente']. "</td>";
                                        echo "<td>". $item['Nombre_Barbero']. "</td>";
                                        echo "<td>". $item['Fecha_Servicio']. "</td>";
                                        echo "<td>". $item['Hora_servicio']. "</td>";
                                        echo "<td>". $item['Nombre_Servicio']. "</td>";
                                        echo "<td>". $item['Valor_servicio']. "</td>";
                                        echo "<td>". $item['Fecha_pago_servicio']. "</td>";
                                        echo "<td>". $item['Saldo_Total']. "</td>";
                                        echo "<td>". $item['Abono']. "</td>";
                                        echo "<td>". $item['Saldo_Pendiente']. "</td>";
                                        echo "<td>". $item['Id_tipo_Servicio']. "</td>";
