...
$consulta = "select * from ingreso_prod";
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>
                ...
                <small>Inventario <a href="https://github.com/mindmup/editable-table" taget="_blank"></a></small>
            </h2>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                         INGRESO DE PRODUCTOS
                         <small>En este modulo podemos ingresar los productos al sistema</small>
                     </h2>
                 </div>
                 <br>
                 <div class="col-md-3">
                    <p>
                        <b style="margin-left: 15px">Proveedor</b>
                    </p>
                    <select class="form-control show-tick">
                        <optgroup label="Proveedor">
                            <option>Barber Productos</option>
                            <option>Rodriguez y productos S.A</option>
                            <option>DFR Y ASOCIADOS</option>
                            <option>PELUQUERIA S.A.S</option>
                        </optgroup>
                    </select>
                </div>
                <br>
                <form style="margin-left: 550px" name="formulario" method="post" action="/send.php">
                    <!-- Campo de entrada de fecha -->
                    
                    Fecha:
                    <input type="date" name="fecha" min="2018-03-25" max="2100-05-25" step="1" />
                    ...
                    <table id="mainTable" class="table table-striped">
                     ...
                     <tbody>
                        <tr>
                            <td>1</td>
                            <td>PB01</td>
                            <td>CERA MOUSTACHE WAX GUMMY</td>
                            <td>12</td>
                            <td>$ 2000</td>
                            <td>$ 24000</td>
                        </tr>
                        ...
                        <tr>
                            <td>3</td>
                            <td>PB09</td>
                            <td>POMADA AZUL COBALTO REUZEL</td>
                            <td>36</td>
                            <td>$ 3258</td>
                            <td>$ 117288</td>
                        </tr>
