...
$consulta1 = "select * from catego_prove";
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            CONSULTA PROVEEDOR
                            <small>En este modulo se puede consultar los proveedores </small>
                        </h2>
                    </div>
                    <div class="body">                          
                        <div class="row clearfix js-sweetalert">
                            <button style="margin-left: 380px; width: 100px; height: 37px" type="button" class="btn btn-success waves-effect" data-toggle="modal" data-target="#defaultModala" >Modificar</button>
                            
                            <button style="margin-right: 380px" type="button" class="btn bg-red waves-effect mover">
                                <i class="material-icons">print</i>
                                <span><a href="../../pages/ui/imp_inventarios.html" style="color: #ffffff">Imprimir</a></span>
                            </button>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="defaultModalLabel">Modificar proveedor</h4>
                                    </div>
                                        ...
                                        <div class="row clearfix unicos">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <select class="form-control show-tick">
                                                            <option>320803480-0</option>
                                                            <option>36231739329-1</option>
                                                            <option>456288031-2</option>
                                                            <option>598703480-0</option>
                                                            <option>753739329-1</option>
                                                            <option>7845220303-3</option>
                                                            <option>927920303-3</option>
                                                            <option>938988031-2</option>
                                            ...
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="text" class="form-control date" placeholder="+00 000-000-00-00" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="number" class="form-control document" placeholder="000-000-00-00" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="tel" class="form-control mobile-phone-number" placeholder="Cll KR 00 # 00-00" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="number" class="form-control money" placeholder="********@*****.com" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 bloqueo t">
                                                <b>Dias para entrega</b>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="material-icons">edit</i>
                                                    </span>
                                                    <div class="form-line">
                                                        <input type="number" class="form-control money" placeholder="00-00" >
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-link waves-effect" onclick="ventana();"><a href="../../pages/ui/Inventario.html" style="color: #000000">Guardar</a></button>
                ...
                <div class="card">
                 <div class="body">
                    <div class="table-responsive">
                        ...
                        echo "<th>Dias de pago (Credito)</th>";
                        echo "<th>Ciudad</th>";
                        ...
                        <?php
                        echo "<tr>";
                        echo "<th>Tipos de productos</th>";
                        echo "<th>Unidad de empaque</th>";
                        echo "<th>Tipo de empaque</th>";
                        echo "<th>Dias para entrega</th>";
                        echo "</tr>";
                        ?>
                            <!--<th>Opción</th>!-->
                    ...
                    <tbody>
                       ...
                       <?php
                        ...
                        echo "<td>".$filas['Num_celular']."</td>";
                        echo "<td>".$filas['Numero_telefono']."</td>";
                        echo "<td>".$filas['Dias_pago_Credito']."</td>";
                    ...
                    <?php
                        ...
                        echo "<tr>";  
                        echo "<td>".$filas1['Tipos_de_productos']."</td>";
                        echo "<td>".$filas1['Unidad_de_empaque']."</td>";
                        echo "<td>".$filas1['Tipo_de_empaque']."</td>";
                        echo "<th>".$filas1['Dias_para_entrega']."</th>";
                        echo "</tr>";
                        }
