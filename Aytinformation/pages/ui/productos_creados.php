...
$consulta = "select * from crear_pro";
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tfoot>
                                    ...
                                    while ($filas = mysqli_fetch_array($result)){
                                      echo "<tr>";
                                      echo "<th>".$filas['Referencia_Producto']."</th>";
                                      echo "<th>".$filas['Descripcion']."</th>";
                                      echo "<th>".$filas['Codigo_De_barras']."</th>";
                                      echo "<th>".$filas['Proveedor']."</th>";
                                      echo "<th>".$filas['Precio_proveedor']."</th>";
                                      echo "<th>".$filas['Precio_publico']."</th>";
                                      echo "<th>".$filas['Fecha']."</th>";
                                      echo "<th>".$filas['Ventas_insumos']."</th>";
                            ...
                            <button style="margin-left: 320px; width: 100px; height: 37px" type="button" class="btn btn-success waves-effect" data-toggle="modal" data-target="#Modal" >Modificar</button>


                            <button style="margin-left:20px;  width: 100px; height: 37px" type="button" class="btn btn-danger waves-effect" data-toggle="modal" data-target="#defaultModal" >Eliminar</button>

                            <button style="margin-right: 290px" type="button" class="btn bg-red waves-effect mover">
                                <i class="material-icons">print</i>
                                <span><a href="../../pages/ui/imp_productos.html" style="color: #ffffff">Imprimir</a></span>
                            </button>
                        </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="number" class="form-control document" placeholder="N° Referencia">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row clearfix">
                                                <div class="col-md-6">
                                                    <b>Motivo de modificacion</b>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">person</i>
                                                        </span>
                                                        <div class="form-line">
                                                            <input type="text" class="form-control date" placeholder="Modificacion">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="tel" class="form-control mobile-phone-number" placeholder="Cod barras">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="tel" class="form-control mobile-phone-number" placeholder="Precio publico">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <b>Precio Proveedor</b>
                                                    <div class="input-group">
                                                        <span class="input-group-addon">
                                                            <i class="material-icons">edit</i>
                                                        </span>
                                                        <div class="form-line">
                                                            <input type="tel" class="form-control mobile-phone-number" placeholder="Precio Proveedor">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-line">
                                                            <input type="tel" class="form-control mobile-phone-number" placeholder="Ventas / Insumos">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                ...
                                <div class="modal-body">
                                 <div class="demo-masked-input">
                                    <div class="row clearfix">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-6">
                                                <b>Motivo de eliminacion</b>
                                                <div class="input-group">
                                                    <span class="input-group-addon">
                                                        <i class="material-icons">person</i>
                                                    </span>
                                                    <div class="form-line">
                                                        <input type="text" class="form-control date" placeholder="Eliminacion">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="form-line">
                                                        <input type="tel" class="form-control mobile-phone-number" placeholder="Cod Usuario">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
