    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                <h2>
                    CREAR PRODUCTO
                    <small>En esta parte del modulo es la creacion de productos</small>
                </h2>
            
            </div >
            <form action="../controladore/ingreso.controlador.php?a=ingr" method="post">
            <div class="body">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control date" name="Item" placeholder="Descrip. Producto" required/>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control datetime" name="Proveedor" placeholder="Nombre Proveedor" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control money-euro" placeholder="Ventas / Insumos" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control money-dollar" name="fecha" placeholder="Ex: 00/00/0000 00:00" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" name="Costo" placeholder="$ ******" required/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input type="text" class="form-control mobile-phone-number" name="Costo_total" placeholder="$ ******" required/>
                                </div>
                            </div>
                        </div>
